...
### Відкрите питання (не з'ясовано в чаті, варто уточнити з Романом)

scribe-mcp та decision-mcp за попереднім дослідженням (Потік 1 вище) — це застосунки, які **вже
використовують Auth0**, не Okta/Juliana/Rex напряму. Незрозуміло:
- Чи Zitadel-експеримент — це заміна Auth0 для цих двох застосунків конкретно (окрема ініціатива від
  Juliana/Rex)?
- Чи це пілот/proof-of-concept, після якого той самий підхід (vendor-abstracted auth layer) планується
  застосувати і до Juliana/Rex, якщо Okta-реселер не дасть прийнятних умов?

Це впливає на те, чи закривати оригінальний Juliana/Rex-рядок в Активні окремо від цього, чи вважати
його тепер частиною ширшої стратегії "спробувати Zitadel, тримати Okta як запасний варіант".
