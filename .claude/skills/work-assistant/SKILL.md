...
Start a new conversation for an unrelated task rather than reusing an old `conversation_id`.
...
criterion) or `vault/Ideas.md` if explicitly not a commitment; anything ambiguous goes to
