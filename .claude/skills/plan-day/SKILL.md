...
- Підмішати з `vault/Open Loops.md` Active те, що має дедлайн сьогодні/цього тижня
...
сьогодні?" — решта в `vault/Open Loops.md` (не втрачається, просто не сьогодні).
...
дублювати. Якщо після replan щось відпало з дня зовсім — воно йде в `vault/Open Loops.md` або
`vault/Inbox.md` як зазвичай, не губиться мовчки.
